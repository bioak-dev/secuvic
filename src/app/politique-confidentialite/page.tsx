...
export const metadata: Metadata = {
  ...
  description:
    "Politique de confidentialité et protection des données personnelles — VICD, service DRIVE&YOU. RGPD, cookies et droits des utilisateurs.",
  ...
  return (
    <main className="min-h-screen bg-ivory text-ink pt-32 pb-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="font-serif text-4xl mb-10">Politique de confidentialité</h1>
        ...
        <div className="space-y-8 text-ink-soft leading-relaxed text-sm font-light">
          ...
          <section>
            <h2 className="text-champagne uppercase tracking-[0.2em] text-[0.7rem] mb-3">Données collectées</h2>
          ...
          <section>
            <h2 className="text-champagne uppercase tracking-[0.2em] text-[0.7rem] mb-3">Finalités</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-champagne uppercase tracking-[0.2em] text-[0.7rem] mb-3">Durée de conservation</h2>
            <p>
          ...
          <section>
            <h2 className="text-champagne uppercase tracking-[0.2em] text-[0.7rem] mb-3">Sous-traitants</h2>
            <ul className="list-disc pl-5 space-y-2">
