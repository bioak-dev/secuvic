  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/images/hero-v-class.png')",
        }}
      >
        <div className="absolute inset-0 bg-black/60 bg-gradient-to-t from-black via-black/40 to-transparent z-0"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center flex flex-col items-center pt-20">
        ...
        >
          ...
          <span className="text-gold-500 tracking-[0.2em] uppercase text-xs md:text-sm font-medium">Service Premium</span>
          <div className="h-[1px] w-12 bg-gold-500"></div>
        </motion.div>
        ...
        >
          Mise à disposition spécialisée en Mercedes Classe V Noir pour vos événements et invités VIC à Cannes, Monaco et Paris.
        </motion.p>
