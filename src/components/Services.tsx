...
const features = [
  {
    ...
    description:
      "Sur demande, nous coordonnons vos déplacements avec des agents de protection agréés (CNAPS), partenaires de confiance, pour un dispositif sécurisé sur-mesure.",
  },
  {
    icon: UserCheck,
    title: "Chauffeurs de Sécurité Formés",
    description:
      "Nos chauffeurs sont formés à la conduite de sécurité et d'évitement et à la gestion des situations sensibles, pour des déplacements maîtrisés en toute circonstance.",
  },
  {
    icon: ScanSearch,
    title: "Confidentialité de l'Habitacle",
    description:
      "Chaque véhicule est systématiquement inspecté à l'aide d'outils professionnels (détection de micros, caméras et traceurs GPS) afin de garantir un environnement totalement confidentiel avant chaque mission.",
  },
  {
    icon: Eye,
    title: "Discrétion Absolue",
    description:
      "Confidentialité totale sur vos déplacements et vos identités. Accords de non-divulgation (NDA) signés sur demande.",
  },
  {
    icon: Star,
    title: "Service VIC Spécialisé",
    description:
      "Un accueil et un accompagnement sur-mesure pour vos invités Very Important Clients. Professionnalisme et élégance garantis.",
  },
  {
    icon: MapPin,
    title: "Cannes, Monaco, Paris",
    description:
      "Présents sur les pôles les plus prestigieux. Idéal pour le Festival de Cannes, le Grand Prix de Monaco ou la Fashion Week de Paris.",
  },
  {
    icon: Clock,
    title: "Mise à Disposition",
    description:
      "Un service flexible à l'heure, à la demi-journée ou à la journée complète selon les exigences de votre emploi du temps.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-serif mb-6">
            Sécurité &amp; <span className="text-gold-500 italic">Prestige</span>
          </h2>
          <p className="text-gray-400 font-light text-lg">
            {SERVICE_NAME} allie le raffinement du transport de luxe à une exigence de sécurité sans compromis.
        ...
        <div className="relative overflow-hidden rounded-sm border border-gold-500/20 bg-gradient-to-br from-black via-zinc-950 to-black p-10 md:p-14">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-start">
            <div className="lg:w-1/2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-gold-500 tracking-[0.2em] uppercase text-xs font-medium">
